...
<body>
    ...
    <section class="content-section">
    	<h1>게시판 수정</h1>
    	<form action="updatePlanAdmin.do" method="post" enctype="multipart/form-data" name="frm">
    	<table >
    		<tr>
   				<td>번호</td>
   				<td>${plan.code}</td>
    		...
    		<tr>
    			<td>내용</td>
    			<td>
    				<textarea cols="40" rows="5" name="description">${plan.description}</textarea>
    			</td>
    		</tr>
    		<tr>
				<th>등록 일자</th>
				<td><input type="text" name="reg_date" value="${plan.reg_date}"></td>
			</tr>
    	</table>	
    		<input type="hidden" name="code" value="${plan.code}"> 
    		<input type="submit" value="수정">
			<input type="button" value="취소" onclick="location.href='adminPlanList.do'">
		</form>
    </section>
  </div>
