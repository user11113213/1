...
<body>
    ...
    <section class="content-section">
    	<h1>게시판 등록</h1>
    	<form action="writeAdminPlan.do" method="post" enctype="multipart/form-data" name="frm">
    	<table >
    		<tr>
    			<td>작성자</td>
    			<td>
    		...
    		<tr>
    			<td>글 내용</td>
    			<td><textarea cols="80" rows="10" name="description" placeholder="내용을 입력해주세요."></textarea></td>
    		</tr>
    		<tr>
				<th>등록 일자</th>
				<td><input type="text" name="reg_date" placeholder="2022-10-04">(예시) 2022-10-04</td>
			</tr>
    	</table>
    		<input type="submit" value="등록">
    		<input type="reset" value="취소"> 
			<input type="button" value="목록" onclick="location.href='adminPlanList.do'">
			</form>
    </section>
  </div>
