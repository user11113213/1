...
* {
	...
	/*contents 들어갈 부분 줄어도 괜찮으니까, padding을 추가해도 box크기는 키우지 않는다*/
}
...
.image-overlay {
	...
	width: 100%;
	height: 100%;
	background: linear-gradient(0deg, rgba(0, 16, 34, 0.8) 0%,
...
<body>
	...
	<div class="app-container">
        ...
        <path stroke-linecap="round" stroke-linejoin="round"
			...
			</a> <a href="Form.jsp" class="item-link" id="pageLink"> <svg
			...
			<h2>사진 게시판 관리</h2>
				<table>
						...
						<tr>
							<td>
								게시판 목록
									<a href="../adminBoardList.do"><input type="submit" value="조회하기" ></a>
							</td>
						</tr>
			...
			<h2>일정 게시판 관리</h2>
				<table>
						...
						<tr>
							<td>
								일정 목록
									<a href="../adminPlanList.do"><input type="submit" value="조회하기" ></a>
							</td>
						</tr>
