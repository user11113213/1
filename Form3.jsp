...
<body>
    ...
    <h1>일정 게시판 리스트(관리자)</h1>
    		...
    		<table>
	    		<tr>
					<td colspan="7"
						...
						<a href="writeAdminPlan.do">게시판 등록</a>
					</td>
				</tr>
	    		<tr>
		    	...
		    	<c:forEach var="plan" items="${planList}">
				    <tr>
				        ...
				        <td>${plan.title}</td>
				        <td>${plan.reg_date}</td>
				        <td><a href="adminPlanDetail.do?code=${plan.code}">상세</a></td>
				        <td><a href="updatePlanAdmin.do?code=${plan.code}">수정</a></td>
			    		<td><a href="deletePlanAdmin.do?code=${plan.code}">삭제</a></td>
				    </tr>
				</c:forEach>
		    </table>
    	...
    	<div>
			<form action="searchPlanAdmin.do">
				<select name="column">
